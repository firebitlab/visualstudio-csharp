...
using System.Diagnostics; //OPEN ANOTHER APPS
...
namespace My_Project
{
    ...
    {   
        /*
         * Template Responsive 1366x768
         *  + Justify seperti web
         *  - Object tidak auto resize
         * 
         * Versi 9 Agustus 2021
         * 
         * 
         */
        ...
        {
            InitializeComponent();
            pictureBox_deg.Image = Compass.DrawCompass(0, pitch, 80, tilt, 80, pictureBox_deg.Size);
        }
        ...
        private void FormSetting_Load(object sender, EventArgs e)
        {
            ...
            toolStripStatusLabel_transmisi.Text = "Koneksi Serial Belum Tersambung";
            toolStripStatusLabel_transmisi.BackColor = Color.Red;
        }
        ...
        private void buttonSambung_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!SerialPort.IsOpen)
                {
                        ...
                        if (SerialPort != null)
                        {
                            ...
                            buttonSambung.Text = "Putus";
                            toolStripStatusLabel_transmisi.Text = "|  Tersambung ke " + SerialPort.PortName +"  |" ;
                            toolStripStatusLabel_transmisi.BackColor = Color.Lime;
                ...
                {
                    SerialPort.DiscardInBuffer(); //Clear all buffer
                    SerialPort.Close();
                    
                    comboBox_comport.Enabled = true;
                    comboBox_baudrate.Enabled = true;
                    buttonSambung.Text = "Hubungkan";
                    toolStripStatusLabel_transmisi.Text = "Koneksi Serial Belum Tersambung";
                    toolStripStatusLabel_transmisi.BackColor = Color.Red;
                }
            }
        ...
        private void my_COMPortAvaliable()
        {
            ...
            {
                comboBox_comport.Items.Add(item);
                comboBox_comport.Text = item;
            }
        }
        ...
        private void SerialPort_DataReceived(object sender, System.IO.Ports.SerialDataReceivedEventArgs e)
        {
            try
            {
                serial_data_in = SerialPort.ReadLine();
            }
            catch { }
        ...
        private void my_parse_data_rutin(object sender, EventArgs e)
        {
            ...
            richTextBox_serial.AppendText(DateTime.Now.ToString("HH:mm:ss:fff ") + serial_data_in + "\n");
            richTextBox_serial.ScrollToCaret();

            foreach (string n in serial_data_in.Split('_'))
            {
                if (n == "#")
                    i = 1;
                data_str[i] = n;
            ...
            if (data_str[1] == "#")
            {
                ...
                textBox_fu.Text = data_str[3]+ " °";
                textBox_nfu.Text = data_str[4] + " °";
                textBox_rotary.Text = data_str[5] + " °";
                textBox_auto.Text = data_str[6] + " °";

                
                pictureBox_deg.Image = Compass.DrawCompass(Convert.ToInt16(data_str[6]), pitch, 80, tilt, 80, pictureBox_deg.Size);


                double mode1 =  Convert.ToDouble(data_str[2]);
                if (mode1 == 2)
                {
                    button_mode_fu.BackColor = System.Drawing.Color.Lime;
                    button_mode_nfu.BackColor = System.Drawing.Color.Black;
                    button_mode_auto.BackColor = System.Drawing.Color.Black;
                    aGauge_rudder.Value = Convert.ToInt16(data_str[3]);
                }
                else if (mode1 == 1)
                {
                    button_mode_fu.BackColor = System.Drawing.Color.Black;
                    button_mode_nfu.BackColor = System.Drawing.Color.Lime;
                    button_mode_auto.BackColor = System.Drawing.Color.Black;
                    aGauge_rudder.Value = Convert.ToInt16(data_str[4]);
                }
                else if (mode1 == 0)
                {
                    button_mode_fu.BackColor = System.Drawing.Color.Black;
                    button_mode_nfu.BackColor = System.Drawing.Color.Black;
                    button_mode_auto.BackColor = System.Drawing.Color.Lime;
                }
                ...
                //sumbux = Convert.ToDouble(data_str[2]);
                //sumbuy = Convert.ToDouble(data_str[3]);
                //curahhujan = Convert.ToDouble(data_str[4]);



                //pergeseran = Convert.ToDouble(data_str[5]);

                //reo1 = Convert.ToInt16(data_str[6]);
        ...
        {
            toolStripStatusLabel_jam.Text = DateTime.Now.ToString("HH:mm:ss");
        }
        ...
        private void button_AUTO_Click(object sender, EventArgs e)
        {
            if (SerialPort.IsOpen)
            {
                SerialPort.WriteLine(textBox_rotary.Text);
            }
        }
    }
